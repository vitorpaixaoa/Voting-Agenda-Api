...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected @NotNull ResponseEntity<Object> handleBindException(
        ...
        String error = ex.getFieldError().toString();
    ...
    protected ResponseEntity<?> handleEntityNotFound(
        ...
        NotFoundDetails nfDetails = new NotFoundDetails(ex.getMessage(), NOT_FOUND.value());
        return new ResponseEntity<>(nfDetails, NOT_FOUND);
    }
    @ExceptionHandler(BadRequestException.class)
    protected ResponseEntity<?> handleBadRequest(
            BadRequestException ex ){
        BadRequestDetails brDetails = new BadRequestDetails(ex.getField(),ex.getMessage(), BAD_REQUEST.value());
        return new ResponseEntity<>(brDetails, BAD_REQUEST);
    }
     ...
     */
    @Override
    protected @NotNull ResponseEntity<Object> handleHttpMessageNotWritable(HttpMessageNotWritableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
